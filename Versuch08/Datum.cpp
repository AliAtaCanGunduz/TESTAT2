...
int Datum::berechneAlterInJahren(const Datum& geburtstag)const
{
    int alter = jahr - geburtstag.jahr;
    if (monat < geburtstag.monat || (monat == geburtstag.monat && tag < geburtstag.tag))
    {
        alter--; 
    }
    return alter;
